  ...
  return (
    <>
      <div className="h-[200px] shrink-0 w-[300px] bg-lime-500 p-4 rounded-xl flex flex-col justify-between sm:w-[250px] sm:p-3 md:w-[220px] md:p-2">
        ...
        <p className="text-sm mt-1 md:text-xs line-clamp-2 text-center">
          {task.description}
        </p>
        <div className="mt-2">
          <button className="w-full bg-green-500 text-white py-1 rounded-lg text-sm md:text-xs md:py-0.5">
            Completed
          </button>
        </div>
      </div>
